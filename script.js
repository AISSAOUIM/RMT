...
const TERRAINS = [
  ...
  ,{
    ...
    roulement: true,
    badge: "🍼 Gynécologie · Belfort",
    summary: "Service de gynécologie-obstétrique de Belfort. Roulement 1S/4, gardes très chargées avec ERCF fréquents et ambiance difficile.",
    scores: { charge: 9, toxicite: 8, formation: 2, liberte: 8, ambiance: 3 },
    highlights: ["Roulement 1S/4", "Gardes très chargées chaque 10-12j", "ERCF fréquents", "Ambiance toxique", "Chambre de garde acceptable"],
    ...
    gardeFreq: "Chaque 10j",
    roulement: true,
    badge: "🍼 Gynécologie · Zéralda",
    summary: "Service de gynécologie de Zéralda. Organisation libre, pas d'ERCF, gardes trinôme. Responsable compréhensive.",
    scores: { charge: 6, toxicite: 4, formation: 6, liberte: 9, ambiance: 8 },
    highlights: ["Roulement libre (officieux)", "Garde trinôme chaque 10j", "Pas d'ERCF", "5 unités (PU/Bloc/Post-partum/GHR/Service)", "TD à présenter"],
    ...
    gardeFreq: "Chaque 9j",
    roulement: true,
    badge: "🍼 Gynécologie · Parnet",
    summary: "Service de gynécologie de Parnet. Meilleur roulement (1S/4-1S/5) mais ambiance très toxique. ERCF exigés par les résidentes.",
    scores: { charge: 6, toxicite: 9, formation: 2, liberte: 9, ambiance: 2 },
    highlights: ["Roulement 1S/4 ou 1S/5", "Garde légère", "ERCF imposés par les résidentes", "Formation nulle", "Ambiance très toxique"],
    review: "Roulement exceptionnel mais équipe extrêmement toxique. On n'apprend rien, on est là pour la tension et les ERCF. 4 obs + validation objectifs exigés.",
    ...
    effectif: "13",
    gardes: true,
    gardeFreq: "Monôme chaque 5j",
    roulement: true,
    badge: "🍼 Gynécologie · Pasteur",
    summary: "Service de gynécologie de Pasteur. Roulement officiel 1S/5, gardes monôme à 13h, service propre et climatisé, équipe globalement gentille.",
    scores: { charge: 7, toxicite: 4, formation: 5, liberte: 8, ambiance: 7 },
    highlights: ["Roulement 1S/5 (officiel)", "Garde monôme dès 13h", "ERCF gérables", "Équipe sympa si sérieux", "Service propre et climatisé"],
    review: "Plutôt sympa, ERCF mais gérables. Cadre agréable, équipe gentille si vous êtes sérieux. Gardes variables (parfois chargées en fin de P car P1 libérés).",
    ...
    effectif: "Variable",
    gardes: true,
    gardeFreq: "Chaque 11j (quadrinôme)",
    roulement: true,
    badge: "🍼 Gynécologie · Ain Taya",
    summary: "Service de gynécologie d'Ain Taya. Charge légère, pas d'ERCF, roulement 1S/3 ou 1S/4. Point négatif : la distance.",
    scores: { charge: 4, toxicite: 5, formation: 6, liberte: 7, ambiance: 7 },
    highlights: ["Roulement 1S/3 ou 1S/4", "Garde quadrinôme chaque 11j", "Pas d'ERCF", "Formateur au PU/Bloc", "TD tous les mardis"],
    review: "Terrain formateur (PU/Bloc). Pas d'ERCF, charge légère, encadrement variable. Point négatif : la distance. Rapport de stage parfois long à valider.",
    ...
    roulement: true,
    badge: "🍼 Gynécologie · Mustapha",
    summary: "4 services (GHR Tarnier, Paul Bar, Réa, Couvelaire). Gardes chargées 24h, ERCF interdits aux internes, gestes possibles si vous les demandez.",
    scores: { charge: 8, toxicite: 4, formation: 7, liberte: 5, ambiance: 8 },
    highlights: ["4 services (GHR/Tarnier/Paul Bar/Réa)", "Garde 24h chaque 8j + post-garde", "ERCF interdits aux internes", "Gestes possibles si demandés", "Equipe non toxique"],
    review: "Expérience dépend du service (roulement variable). Gardes chargées mais ERCF interdits et équipe bienveillante. On peut apprendre si on s'implique.",
    ...
    effectif: "Variable",
    gardes: true,
    gardeFreq: "Chaque 10j (quadrinôme)",
    roulement: true,
    badge: "🍼 Gynécologie · Kouba",
    summary: "Service de gynécologie de Kouba. Roulement 4/jour, garde quadrinôme chaque 10j, service léger mais formation inexistante et résidents difficiles.",
    scores: { charge: 5, toxicite: 8, formation: 1, liberte: 8, ambiance: 3 },
    highlights: ["Roulement 4/jour", "Garde quadrinôme chaque 10j", "Charge légère", "Formation zéro (PAS de gestes)", "Résidents très difficiles"],
    review: "Léger niveau charge mais formation inexistante et résidents difficiles. TDs 2x/semaine présence notée.",
    ...
    gardeFreq: "Chaque 8j",
    roulement: false,
    badge: "🍼 Gynécologie · HMEA",
    summary: "HMEA — Gardes très chargées (chaque 8j), ERCF++++ et constantes, pas de chambre de garde. Service propre et organisé mais très épuisant.",
    scores: { charge: 9, toxicite: 8, formation: 3, liberte: 5, ambiance: 4 },
    highlights: ["Garde chaque 8j (très chargée)", "ERCF++++ et constantes", "Pas de chambre de garde", "Pointage obligatoire", "Propre et organisé"],
    review: "Très fatiguant, corvées (ERCF, constantes) et même pas de chambre de garde. Si vous avez le choix, évitez. Gros points positifs : la propreté.",
    epuisement: { p1: "1136", p2: "1113", p3: "1150", p4: "900" }
  },{
    id: 107,
    name: "Gynécologie Bologhine",
    hospital: "Baineim",
    specialty: "gynécologie",
    type: "gynécologie",
    icon: "🍼",
    ...
    effectif: "21",
    gardes: true,
    gardeFreq: "Trinôme (chaque 6-12j)",
    roulement: true,
    badge: "🍼 Gynécologie · Bologhine",
    summary: "Service de gynécologie Bologhine (Baineim). Résidents sympas, accès au bloc, rapport d'activité obligatoire pour tous les P.",
    scores: { charge: 6, toxicite: 3, formation: 7, liberte: 7, ambiance: 8 },
    highlights: ["Garde trinôme (chaque 6-12j)", "Roulement 1S/2 en fin de stage", "Peu de travail au service", "Accès au bloc opératoire", "Rapport d'activité obligatoire (tous P)"],
    review: "Bien passé. Résidents sympas, on peut apprendre au bloc si on veut. Rapport d'activité obligatoire sinon stage non validé. Note : 7.5/10.",
    ...
    roulement: true,
    badge: "🍼 Gynécologie · Thenia",
    summary: "Service de gynécologie de Thenia. Prof très gentille, roulement en trinôme par mois d'unité, gardes chaque 8-9j, TD à présenter.",
    scores: { charge: 7, toxicite: 3, formation: 7, liberte: 4, ambiance: 8 },
    highlights: ["Prof tres sympa", "Garde chaque 8-9j", "3 unités avec roulement mensuel", "TD à présenter", "P4 : que des gardes (chaque 9j)"],
    review: "Equipe sympa (la prof est un sucre). Gardes gérables, bonne ambiance générale. En P4 : uniquement des gardes et post-gardes.",
    ...
    gardeFreq: "Chaque 9j",
    roulement: false,
    badge: "🍼 Gynécologie · Beni Messous",
    summary: "Gynécologie BM — Secrétaire stricte imposant le pointage. Pas de roulement semaine. Terrain chill uniquement si les internes sont solidaires. 8 unités.",
    scores: { charge: 7, toxicite: 6, formation: 5, liberte: 4, ambiance: 6 },
    highlights: ["Secrétaire stricte (pointage)", "8 unités dans le service", "Garde chaque 9j", "Pas de roulement semaine", "Chill si solidaires (effectif 35+)"],
    review: "Pas de roulement semaine à cause de la secrétaire. Terrain chill seulement si les internes sont solidaires. Résidentes : certaines toxiques, d'autres non.",
